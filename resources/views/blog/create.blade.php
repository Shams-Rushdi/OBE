        ...
        <div class="card">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="author" value="{{old('author')}}" id="example-text-input">
                ...
                <div class="form-group">
                    ...
                    <label for="example-text-input" class="col-form-label">Blog Post Video (Copy and paste Vido Link)</label>
                    <input class="form-control" type="text" name="video" value="{{old('video')}}" id="example-text-input">
                    ...
                    <textarea id="editor" class="form-control" type="text" name="content" id="example-text-input" rows="3">
                        {{old('content')}}
                    </textarea>
                    @error('content')
                        <p class="text-danger">{{$message}}</p>
