      ...
      <div class="col-auto">
        <div class="h-100">
          ...
          <p class="mb-0 font-weight-bold text-sm">
            {{$roleName = $students->getRoleNames()->first();}} ({{$students->plan->membership_type ?? ''}}) 
          </p>
          <p class="mb-0 font-weight-bold text-sm">
      ...
      <div class="card h-100">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" style="text-align: left">
                        <form role="form text-left"  action="{{route('alumni.profile.submit',$students->id)}}" method="post" enctype="multipart/form-data">
                          {{@csrf_field()}}
                          @method('PUT')
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" name="company_name" value="{{$students->company_name}}" id="message-text"></textarea>
                          </div>
                          <div class="form-group">
                            <label for="message-text" class="col-form-label">designation_letter:</label>
                            <input class="form-control" name="designation_letter" value="{{$students->designation_letter}}" id="message-text"></textarea>
                          </div>
                          <div class="form-group">
                            <label for="message-text" class="col-form-label">Experience (Year/Months):</label>
                            <input class="form-control" name="experience" value="{{$students->experience}}" id="message-text"></textarea>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <textarea id="editor" class="form-control" name="bio" id="message-text">{!!$students->bio!!}</textarea>
                          </div>
                          <div class="form-group" >
        ...
        <div class="card-body p-3">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Student Id:</strong> &nbsp; {{$students->student_id}}</li>
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Batch No:</strong> &nbsp; {{$students->batch_id}}</li>
            ...
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Passing Year:</strong> &nbsp; {{$students->passing_year}}</li>
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Location:</strong> &nbsp; {{$students->present_address}}</li>
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Company Name:</strong> &nbsp; {{$students->company_name}}</li>
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Designation Letter:</strong> &nbsp; {{$students->designation_letter}}</li>
            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Experience:</strong> &nbsp; {{$students->experience}}</li>
