        ...
        <div class="col-xl-3 col-md-6 mb-xl-4 mb-4">
          <div class="card card-blog card-plain">
            <div class="position-relative">
              ...
              <img src="{{asset('uploads/'.$blog->image)}}" style="height: 250px;width: 400px;" alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
              </a>
            </div>
            <div class="card-body px-1 pb-0">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <a href="{{route('blogs.show',$blog->id)}}" class="btn btn-outline-primary btn-sm mb-0">View Details</a>
              </div>
            </div>
          </div>
        </div>
